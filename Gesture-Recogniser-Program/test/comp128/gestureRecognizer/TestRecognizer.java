...
/**
* Tests that calculateCentroid is correct
*/
...
@Test
    public void testCalculateCentroid() {
        ...
        Point centroid = recognizer.calculateCentroid(points);

        assertEquals(9.0 / 3, centroid.getX(), 0.0001); 
        assertEquals(12.0 / 3, centroid.getY(), 0.0001); 
    }
   ...
   public void testRecognize(){
       ...
       Result result1 = recognizer.recognize(templateGesture);
